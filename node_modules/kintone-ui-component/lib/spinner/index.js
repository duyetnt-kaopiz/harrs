...
let exportSpinner;
(() => {
    exportSpinner = window.customElements.get("kuc-spinner-1-23-1");
    if (exportSpinner) {
        return;
    }
    class KucSpinner extends KucBase {
      ...
      `;
        ...
        <div class="kuc-spinner-1-23-1__spinner" aria-live="assertive" role="alert">
          ...
          <div
            class="kuc-spinner-1-23-1__spinner__text${!this.text
                ? " visually-hidden"
                : ""}"
          >
    ...
    ], KucSpinner.prototype, "className", void 0);
    __decorate([
        property({ type: String, reflect: true, attribute: "id" })
    ], KucSpinner.prototype, "id", void 0);
    __decorate([
        property({ type: String })
    ], KucSpinner.prototype, "text", void 0);
    __decorate([
        property()
    ], KucSpinner.prototype, "container", void 0);
    window.customElements.define("kuc-spinner-1-23-1", KucSpinner);
