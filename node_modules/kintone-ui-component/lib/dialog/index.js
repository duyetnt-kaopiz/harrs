...
let exportDialog;
(() => {
    exportDialog = window.customElements.get("kuc-dialog-1-23-1");
    if (exportDialog) {
        return;
    }
    ...
    ], KucDialog.prototype, "className", void 0);
    __decorate([
        property({ type: String })
    ], KucDialog.prototype, "icon", void 0);
    __decorate([
        property({ type: String, reflect: true, attribute: "id" })
    ], KucDialog.prototype, "id", void 0);
    __decorate([
        property({ type: String })
    ...
    __decorate([
        query(".kuc-dialog-1-23-1__dialog")
    ...
    window.customElements.define("kuc-dialog-1-23-1", KucDialog);
