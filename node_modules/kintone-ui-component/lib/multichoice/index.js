...
(() => {
    exportMultiChoice = window.customElements.get("kuc-multi-choice-1-23-1");
    ...
    class KucMultiChoice extends KucBase {
        constructor(props) {
            ...
            this.value = [];
            this._valueMapping = {};
            this._DISABLED_CLASS = "kuc-multi-choice-1-23-1__group__menu__item--disabled";
      ...
      `;
        ...
        _handleMouseOverMultiChoiceItem(event) {
            ...
            this._itemsEl.forEach((itemEl) => {
                if (itemEl.classList.contains("kuc-multi-choice-1-23-1__group__menu__highlight")) {
                    itemEl.classList.remove("kuc-multi-choice-1-23-1__group__menu__highlight");
                }
            });
            const itemEl = event.currentTarget;
            itemEl.classList.add("kuc-multi-choice-1-23-1__group__menu__highlight");
        ...
        _actionHighlightPrevMenuItem() {
            ...
            if (prevItemIsDisabled)
                return;
            prevItem.classList.add("kuc-multi-choice-1-23-1__group__menu__highlight");
        ...
        _actionHighlightNextMenuItem() {
            ...
            if (nextItemIsDisabled)
                return;
            nextItem.classList.add("kuc-multi-choice-1-23-1__group__menu__highlight");
        ...
        _getMenuItemTemplate(item, index) {
            ...
            return html `
        <div
          class="kuc-multi-choice-1-23-1__group__menu__item ${isDisabledItem
          ...
          @mouseleave="${!isDisabledItem
                ...
                : null}"
        >
          ${this._getMultiChoiceCheckedIconSvgTemplate(isDisabledItem, isCheckedItem)}
    ...
    __decorate([
        query(".kuc-multi-choice-1-23-1__group__menu")
    ], KucMultiChoice.prototype, "_menuEl", void 0);
    __decorate([
        queryAll(".kuc-multi-choice-1-23-1__group__menu__item")
    ], KucMultiChoice.prototype, "_itemsEl", void 0);
    __decorate([
        query(".kuc-multi-choice-1-23-1__group__menu__item")
    ], KucMultiChoice.prototype, "_firstItemEl", void 0);
    __decorate([
        query(".kuc-multi-choice-1-23-1__group__menu__item:last-child")
    ], KucMultiChoice.prototype, "_lastItemEl", void 0);
    __decorate([
        query(".kuc-multi-choice-1-23-1__group__menu__highlight")
    ], KucMultiChoice.prototype, "_highlightItemEl", void 0);
    __decorate([
        state()
    ], KucMultiChoice.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-multi-choice-1-23-1", KucMultiChoice);
