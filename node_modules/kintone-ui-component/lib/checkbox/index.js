...
let exportCheckbox;
(() => {
    exportCheckbox = window.customElements.get("kuc-checkbox-1-23-1");
    if (exportCheckbox) {
        return;
    }
  ...
  `;
    ...
    __decorate([
        queryAll(".kuc-checkbox-1-23-1__group__select-menu__item__input")
    ], KucCheckbox.prototype, "_inputEls", void 0);
    __decorate([
        state()
    ], KucCheckbox.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-checkbox-1-23-1", KucCheckbox);
