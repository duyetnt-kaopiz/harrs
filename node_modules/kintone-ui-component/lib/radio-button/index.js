...
(() => {
    exportRadioButton = window.customElements.get("kuc-radio-button-1-23-1");
  ...
  `;
        ...
        >
          ...
          <label
            ...
            >${this._getRadioIconSvgTemplate(isDisabledItem, isCheckedItem)}${item.label === undefined ? item.value : item.label}
          </label>
        </div>
      `;
        }
    ...
    __decorate([
        queryAll(".kuc-radio-button-1-23-1__group__select-menu__item__input")
    ], KucRadioButton.prototype, "_inputEls", void 0);
    window.customElements.define("kuc-radio-button-1-23-1", KucRadioButton);
