...
let exportCombobox;
(() => {
    exportCombobox = window.customElements.get("kuc-combobox-1-23-1");
    if (exportCombobox) {
        return;
    }
    class KucCombobox extends KucBase {
        constructor(props) {
            ...
            this._searchText = "";
            this._DISABLED_CLASS = "kuc-combobox-1-23-1__group__select-menu__item--disabled";
            this._query = "";
            this._matchingItems = [];
    ...
    `;
        ...
        `;
            ...
            return html `
        <li
          class="kuc-combobox-1-23-1__group__select-menu__item ${isDisabled
      ...
      ${checked
        ...
        _handleClickComboboxItem(event) {
        ...
        _actionClearAllHighlightMenuItem() {
            this._itemsEl.forEach((itemEl) => {
                itemEl.classList.remove("kuc-combobox-1-23-1__group__select-menu__highlight");
            });
            this._actionRemoveActiveDescendant();
        }
        ...
        _actionHighlightMenuItem(item) {
            this._actionClearAllHighlightMenuItem();
            item.classList.add("kuc-combobox-1-23-1__group__select-menu__highlight");
        }
        ...
        _getItemElementWhenMouseOverDown(eventTarget) {
            if (eventTarget.classList.value
                .split(" ")
                .includes("kuc-combobox-1-23-1__group__select-menu__item")) {
                return eventTarget;
            }
    ...
    __decorate([
        property({ type: String })
    ], KucCombobox.prototype, "placeholder", void 0);
    __decorate([
        property({ type: String })
    ...
    __decorate([
        query(".kuc-combobox-1-23-1__group__toggle")
    ], KucCombobox.prototype, "_toggleEl", void 0);
    __decorate([
        query(".kuc-combobox-1-23-1__group__toggle__input")
    ], KucCombobox.prototype, "_inputEl", void 0);
    __decorate([
        query(".kuc-combobox-1-23-1__group__select-menu")
    ], KucCombobox.prototype, "_menuEl", void 0);
    __decorate([
        queryAll(".kuc-combobox-1-23-1__group__select-menu__item")
    ], KucCombobox.prototype, "_itemsEl", void 0);
    __decorate([
        query(".kuc-combobox-1-23-1__group__select-menu__item")
    ], KucCombobox.prototype, "_firstItemEl", void 0);
    __decorate([
        query(".kuc-combobox-1-23-1__group__select-menu__item:last-child")
    ], KucCombobox.prototype, "_lastItemEl", void 0);
    __decorate([
        query(".kuc-combobox-1-23-1__group__select-menu__item[aria-selected=true]")
    ], KucCombobox.prototype, "_selectedItemEl", void 0);
    __decorate([
        query(".kuc-combobox-1-23-1__group__select-menu__highlight")
    ], KucCombobox.prototype, "_highlightItemEl", void 0);
    __decorate([
        query(".kuc-base-error-1-23-1__error")
    ], KucCombobox.prototype, "_errorEl", void 0);
    __decorate([
        queryAll(".kuc-combobox-1-23-1__group__select-menu__item--disabled")
    ], KucCombobox.prototype, "_disabledItemsEl", void 0);
    __decorate([
        state()
    ], KucCombobox.prototype, "_searchText", void 0);
    window.customElements.define("kuc-combobox-1-23-1", KucCombobox);
