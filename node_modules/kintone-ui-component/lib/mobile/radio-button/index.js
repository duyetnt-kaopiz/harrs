...
(() => {
    exportMobileRadioButton = window.customElements.get("kuc-mobile-radio-button-1-23-1");
    ...
    `;
        ...
        _getItemTemplate(item, index) {
            ...
            return html `
        <div
          class="kuc-mobile-radio-button-1-23-1__group__select-menu__item${item.disabled
    ...
    __decorate([
        queryAll(".kuc-mobile-radio-button-1-23-1__group__select-menu__item__input")
    ], KucMobileRadioButton.prototype, "_inputEls", void 0);
    window.customElements.define("kuc-mobile-radio-button-1-23-1", KucMobileRadioButton);
