...
import { isValidDate, validateDateTimeValue, validateProps, } from "../../base/validator";
...
(() => {
    exportMobileDateTimePicker = window.customElements.get("kuc-mobile-datetime-picker-1-23-1");
    ...
    window.customElements.define("kuc-mobile-datetime-picker-1-23-1", KucMobileDateTimePicker);
