...
(() => {
    exportMobileDatePicker = window.customElements.get("kuc-mobile-date-picker-1-23-1");
    ...
    window.customElements.define("kuc-mobile-date-picker-1-23-1", KucMobileDatePicker);
