...
(() => {
    exportMobileTimePicker = window.customElements.get("kuc-mobile-time-picker-1-23-1");
    ...
    window.customElements.define("kuc-mobile-time-picker-1-23-1", KucMobileTimePicker);
