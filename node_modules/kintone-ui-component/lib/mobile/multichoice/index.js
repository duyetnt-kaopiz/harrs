...
(() => {
    exportMobileMultiChoice = window.customElements.get("kuc-mobile-multi-choice-1-23-1");
    ...
    window.customElements.define("kuc-mobile-multi-choice-1-23-1", KucMobileMultiChoice);
