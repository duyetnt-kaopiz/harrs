...
(() => {
    exportMobileCheckbox = window.customElements.get("kuc-mobile-checkbox-1-23-1");
    ...
    class KucMobileCheckbox extends KucBase {
       ...
       `;
        ...
        <label
          ...
          class="kuc-mobile-checkbox-1-23-1__group__select-menu__item${item.disabled
      ...
      `;
        ...
        <fieldset class="kuc-mobile-checkbox-1-23-1__group">
          ...
          <div
            class="kuc-mobile-checkbox-1-23-1__group__select-menu ${this.requiredIcon
                ? "kuc-mobile-checkbox-1-23-1__group__select-menu--required"
                : ""}"
            ?borderVisible="${this.borderVisible}"
    ...
    __decorate([
        queryAll(".kuc-mobile-checkbox-1-23-1__group__select-menu__item__input")
    ], KucMobileCheckbox.prototype, "_inputEls", void 0);
    __decorate([
        state()
    ], KucMobileCheckbox.prototype, "_valueMapping", void 0);
    window.customElements.define("kuc-mobile-checkbox-1-23-1", KucMobileCheckbox);
