...
(() => {
    exportMobileDropdown = window.customElements.get("kuc-mobile-dropdown-1-23-1");
    ...
    __decorate([
        query(".kuc-mobile-dropdown-1-23-1__input-form__select__input")
    ], KucMobileDropdown.prototype, "_selectEl", void 0);
    window.customElements.define("kuc-mobile-dropdown-1-23-1", KucMobileDropdown);
