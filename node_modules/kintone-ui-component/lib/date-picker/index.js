...
import { dateValueConverter, languagePropConverter, visiblePropConverter, } from "../base/converter";
...
import { isValidDate, validateDateValue, validateProps, } from "../base/validator";
import "../base/datetime/date";
import { DATE_PICKER_CSS } from "./style";
export { BaseError, BaseLabel };
let exportDatePicker;
(() => {
    exportDatePicker = window.customElements.get("kuc-date-picker-1-23-1");
    if (exportDatePicker) {
        return;
    }
    ...
    window.customElements.define("kuc-date-picker-1-23-1", KucDatePicker);
