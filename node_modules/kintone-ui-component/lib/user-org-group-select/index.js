...
import { validateArrayType, validateDuplicatedValues, validateProps, } from "../base/validator";
import { USER_ORG_GROUP_SELECT_CSS } from "./style";
let exportUserOrgGroupSelect;
(() => {
    exportUserOrgGroupSelect = window.customElements.get("kuc-user-org-group-select-1-23-1");
    ...
    class KucUserOrgGroupSelect extends KucBase {
        constructor(props) {
            ...
            this._query = "";
            this._matchingItems = [];
            this._DISABLED_ITEM_CLASS = "kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item--disabled";
            this._DISABLED_ICON_CLASS = "kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item__icon--disabled";
            this._SMALL_ICON_SIZE = 24;
            this._LARGE_ICON_SIZE = 48;
        ...
        <div class="kuc-user-org-group-select-1-23-1__group">
          ...
          <div class="kuc-user-org-group-select-1-23-1__group__container">
            ...
            >
              ...
              >
                ${this._matchingItems.map((item, number) => this._getMatchedItemTemplate(item, number))}
              </ul>
              <ul
                class="kuc-user-org-group-select-1-23-1__group__container__select-area__selected-list"
              >
                ${this._selectedValues.map((value, index) => this._getSelectedItemTemplate(value, index))}
              </ul>
            </div>
            <div
      ...
      `;
        ...
        _initializeSelectedValues() {
            if (Array.isArray(this.value)) {
                this._selectedValues = this.value.filter((value) => this.items.some((item) => item.value === value));
            }
        }
        _getMatchedItemTemplate(item, index) {
            const text = item.label === undefined || item.label === null
                ? item.value
                : item.label;
        ...
        `;
            ...
            return html `
        <li
          class="kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item ${isDisabled
        ...
        >
          <div
            class="kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item__icon ${isDisabled
      ...
      `;
        ...
        _getSelectedItemTemplate(value, index) {
            const selectedItem = this.items.filter((item) => item.value === value)[0];
            if (!selectedItem)
                return "";
            const disabled = selectedItem === null || selectedItem === void 0 ? void 0 : selectedItem.disabled;
            const text = selectedItem.label === undefined || selectedItem.label === null
                ? selectedItem.value
                : selectedItem.label;
            return html `
        <li
        ...
        >
          ...
          >
            ...
            >
              ${this._getSvgTemplateByType(selectedItem.type || "", this._SMALL_ICON_SIZE)}
            </div>
            <div
              class="kuc-user-org-group-select-1-23-1__group__container__select-area__selected-list__item__content__text ${disabled
      ...
      `;
        ...
        _handleChangeUserOrgGroupInput(event) {
            event.stopPropagation();
        }
        _handleInputUserOrgGroupInput(event) {
            event.stopPropagation();
            this._searchText = this._inputEl.value;
            this._query = this._inputEl.value;
            this._setMatchingItems();
        }
        _handleClickUserOrgGroupInput(event) {
            event.stopPropagation();
            this._inputEl.select();
            this._setMatchingItems();
        }
        _handleBlurUserOrgGroupInput(event) {
        ...
        _handleKeyDownUserOrgGroupInput(event) {
            switch (event.key) {
        ...
        _actionHighlightPrevMenuItem() {
            ...
            for (let i = 0; i < this._matchingItems.length; i++) {
                prevItemIsDisabled = prevItem.classList.contains(this._DISABLED_ITEM_CLASS);
        ...
        _actionHighlightNextMenuItem() {
            ...
            for (let i = 0; i < this._matchingItems.length; i++) {
                nextItemIsDisabled = nextItem.classList.contains(this._DISABLED_ITEM_CLASS);
        ...
        _handleClickRemoveSelectedItem(event) {
            const button = event.currentTarget;
            const index = parseInt(button.getAttribute("selected-item-index") || "-1", 10);
        ...
        _handleMouseDownToggleButton(event) {
            event.preventDefault();
        }
        _handleClickIconButton(event) {
            event.preventDefault();
            const clickIconEventDetail = {
                value: this.value,
            };
        ...
        _setMenuPositionAboveOrBelow() {
            ...
            const menuHeightWithMaxHeight = this._menuEl.getBoundingClientRect().height;
        ...
        _handleMouseOverUserOrgGroupItem(event) {
        ...
        _actionHighlightMenuItem(item) {
            ...
            item.classList.add("kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item__highlight");
        }
        _handleClickUserOrgGroupItem(event) {
            const itemEl = this._getItemElementWhenMouseOverDown(event.target);
            const value = itemEl.getAttribute("value");
            this._actionUpdateValue(value);
        }
        ...
        _getItemElementWhenMouseOverDown(eventTarget) {
            if (eventTarget.classList.value
                .split(" ")
                .includes("kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item")) {
                return eventTarget;
            }
        ...
        _actionClearAllHighlightMenuItem() {
            this._itemsEl.forEach((itemEl) => {
                ...
                itemEl.classList.remove("kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item__highlight");
            });
        ...
        _getPickerSVGTemplateByIcon(icon) {
            if (!icon)
                return "";
            switch (icon) {
                case "user":
        ...
        _getSvgTemplateByType(type, size = this._LARGE_ICON_SIZE) {
            if (!type)
                return "";
            switch (type) {
                case "user":
    ...
    ], KucUserOrgGroupSelect.prototype, "className", void 0);
    __decorate([
        property({ type: String })
    ], KucUserOrgGroupSelect.prototype, "error", void 0);
    __decorate([
        property({ type: String })
    ], KucUserOrgGroupSelect.prototype, "icon", void 0);
    __decorate([
        property({ type: String, reflect: true, attribute: "id" })
    ], KucUserOrgGroupSelect.prototype, "id", void 0);
    __decorate([
        property({ type: String })
    ], KucUserOrgGroupSelect.prototype, "label", void 0);
    __decorate([
        property({ type: String })
    ], KucUserOrgGroupSelect.prototype, "placeholder", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucUserOrgGroupSelect.prototype, "disabled", void 0);
    __decorate([
        property({ type: Boolean })
    ], KucUserOrgGroupSelect.prototype, "requiredIcon", void 0);
    __decorate([
        property({
            type: Boolean,
            attribute: "hidden",
    ...
    ], KucUserOrgGroupSelect.prototype, "visible", void 0);
    __decorate([
        property({ type: Array })
    ], KucUserOrgGroupSelect.prototype, "items", void 0);
    __decorate([
        property({ type: Array })
    ], KucUserOrgGroupSelect.prototype, "value", void 0);
    __decorate([
        queryAll(".kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item")
    ], KucUserOrgGroupSelect.prototype, "_itemsEl", void 0);
    __decorate([
        query(".kuc-user-org-group-select-1-23-1__group__container__select-area__toggle__input")
    ], KucUserOrgGroupSelect.prototype, "_inputEl", void 0);
    __decorate([
        query(".kuc-user-org-group-select-1-23-1__group__container__select-area__toggle")
    ], KucUserOrgGroupSelect.prototype, "_toggleEl", void 0);
    __decorate([
        query(".kuc-user-org-group-select-1-23-1__group__container__select-area")
    ], KucUserOrgGroupSelect.prototype, "_selectAreaEl", void 0);
    __decorate([
        query(".kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu")
    ], KucUserOrgGroupSelect.prototype, "_menuEl", void 0);
    __decorate([
        query(".kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item__highlight")
    ], KucUserOrgGroupSelect.prototype, "_highlightItemEl", void 0);
    __decorate([
        query(".kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item:first-child")
    ], KucUserOrgGroupSelect.prototype, "_firstItemEl", void 0);
    __decorate([
        query(".kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item:last-child")
    ], KucUserOrgGroupSelect.prototype, "_lastItemEl", void 0);
    __decorate([
        queryAll(".kuc-user-org-group-select-1-23-1__group__container__select-area__select-menu__item--disabled")
    ], KucUserOrgGroupSelect.prototype, "_disabledItemsEl", void 0);
    __decorate([
        state()
    ], KucUserOrgGroupSelect.prototype, "_selectedValues", void 0);
    __decorate([
        state()
    ], KucUserOrgGroupSelect.prototype, "_searchText", void 0);
    __decorate([
        state()
    ], KucUserOrgGroupSelect.prototype, "_selectorVisible", void 0);
    window.customElements.define("kuc-user-org-group-select-1-23-1", KucUserOrgGroupSelect);
    createStyleOnHeader(USER_ORG_GROUP_SELECT_CSS);
    exportUserOrgGroupSelect = KucUserOrgGroupSelect;
})();
const UserOrgGroupSelect = exportUserOrgGroupSelect;
