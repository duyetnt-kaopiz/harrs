...
let exportTooltip;
(() => {
    exportTooltip = window.customElements.get("kuc-tooltip-1-23-1");
    if (exportTooltip) {
        return;
    }
        ...
        _showTooltip() {
            ...
            this._tooltips.forEach((tooltip) => {
                if (tooltip.id === `${this._GUID}-title`) {
                    tooltip.classList.remove("kuc-tooltip-1-23-1__group__title--hidden");
                }
            });
        }
        _hideTooltip() {
            ...
            this._tooltips.forEach((tooltip) => {
                if (tooltip.id === `${this._GUID}-title`) {
                    tooltip.classList.add("kuc-tooltip-1-23-1__group__title--hidden");
                }
            });
        }
    ...
    __decorate([
        query(".kuc-tooltip-1-23-1__group__container")
    ], KucTooltip.prototype, "_groupContainerEL", void 0);
    __decorate([
        query(".kuc-tooltip-1-23-1__group__title__wrapper")
    ], KucTooltip.prototype, "_titleWrapper", void 0);
    __decorate([
        queryAll(".kuc-tooltip-1-23-1__group__title")
    ], KucTooltip.prototype, "_tooltips", void 0);
    window.customElements.define("kuc-tooltip-1-23-1", KucTooltip);
