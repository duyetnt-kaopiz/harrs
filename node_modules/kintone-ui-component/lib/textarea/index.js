...
let exportTextarea;
(() => {
    exportTextarea = window.customElements.get("kuc-textarea-1-23-1");
    if (exportTextarea) {
        return;
    }
    ...
    __decorate([
        query(".kuc-textarea-1-23-1__group__container")
    ], KucTextArea.prototype, "_container", void 0);
    __decorate([
        query(".kuc-textarea-1-23-1__group__textarea")
    ], KucTextArea.prototype, "_textarea", void 0);
    window.customElements.define("kuc-textarea-1-23-1", KucTextArea);
