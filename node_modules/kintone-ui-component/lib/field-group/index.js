...
(() => {
    exportFieldGroup = window.customElements.get("kuc-field-group-1-23-1");
    if (exportFieldGroup) {
        return;
    }
    ...
    __decorate([
        query(".kuc-field-group-1-23-1__group")
    ], KucFieldGroup.prototype, "_groupEl", void 0);
    __decorate([
        query(".kuc-field-group-1-23-1__group__body")
    ], KucFieldGroup.prototype, "_bodyEl", void 0);
    __decorate([
        query(".kuc-field-group-1-23-1__group__toggle")
    ], KucFieldGroup.prototype, "_toggle", void 0);
    window.customElements.define("kuc-field-group-1-23-1", KucFieldGroup);
