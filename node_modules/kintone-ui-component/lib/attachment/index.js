...
import { validateArrayType, validatePositiveInteger, validateProps, } from "../base/validator";
import { ATTACHMENT_CSS } from "./style";
let exportAttachment;
(() => {
    exportAttachment = window.customElements.get("kuc-attachment-1-23-1");
    if (exportAttachment) {
        return;
    }
    class KucAttachment extends KucBase {
      ...
      <div class="kuc-attachment-1-23-1__group">
        ...
        >
          ...
          >
          ${this.files.map((item, number) => this._getAttachmentItemTemplate(item, number))}
          </ul>
          ...
          <p class="kuc-attachment-1-23-1__group__files__browse-message${this.disabled
    ...
    `;
        ...
        _getAttachmentItemTemplate(item, index) {
            return html `
      ...
      `;
        ...
        _updateFileNameMaxWidth() {
            ...
            this._fileItemsEl.forEach((fileItem) => {
                fileItem.style.maxWidth = `calc(var(--kuc-attachment-width, ${labelElWidth < 191 ? 191 : labelElWidth}px) - ${(FILES_PADDING_AND_BORDER_WIDTH + FILE_ITEM_BORDER_WIDTH) * 2}px)`;
            });
        }
      ...
      >
        ...
        _handleDragDrop(event) {
            if (this.disabled || !this._isDraging)
                return;
            event.preventDefault();
    ...
    __decorate([
        property({ type: String })
    ], KucAttachment.prototype, "message", void 0);
    __decorate([
    ...
    __decorate([
        query(".kuc-attachment-1-23-1__group__files")
    ], KucAttachment.prototype, "_groupFilesEl", void 0);
    __decorate([
        query(".kuc-attachment-1-23-1__group__files__droppable__text")
    ], KucAttachment.prototype, "_dragTextEl", void 0);
    __decorate([
        query(".kuc-attachment-1-23-1__group__files__browse-button__input-container__input")
    ], KucAttachment.prototype, "_inputEl", void 0);
    __decorate([
        query(".kuc-attachment-1-23-1__group__label")
    ], KucAttachment.prototype, "_labelEl", void 0);
    __decorate([
        queryAll(".kuc-attachment-1-23-1__group__files__display-area__item__name")
    ], KucAttachment.prototype, "_fileItemsEl", void 0);
    __decorate([
        queryAll(".kuc-attachment-1-23-1__group__files__display-area__item__remove-button__container__button")
    ], KucAttachment.prototype, "_fileRemoveButtons", void 0);
    window.customElements.define("kuc-attachment-1-23-1", KucAttachment);
