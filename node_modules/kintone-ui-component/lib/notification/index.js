...
(() => {
    exportNotification = window.customElements.get("kuc-notification-1-23-1");
    ...
    class KucNotification extends KucBase {
      ...
      `;
        ...
        open() {
            ...
            this.performUpdate();
            this.classList.remove("kuc-notification-fadeout-1-23-1");
            this.classList.add("kuc-notification-fadein-1-23-1");
            this._isOpened = true;
            this._setAutoCloseTimer();
        }
        _close() {
            this._isOpened = false;
            this.classList.remove("kuc-notification-fadein-1-23-1");
            this.classList.add("kuc-notification-fadeout-1-23-1");
            this._clearAutoCloseTimer();
        }
        close() {
            this._close();
        ...
        render() {
            return html `
        <div
          class="kuc-notification-1-23-1__notification kuc-notification-1-23-1__notification--${this
                .type}"
        >
          <pre
    ...
    ], KucNotification.prototype, "id", void 0);
    __decorate([
    ...
    __decorate([
        property()
    ], KucNotification.prototype, "content", void 0);
    __decorate([
        state()
    ], KucNotification.prototype, "_isOpened", void 0);
    window.customElements.define("kuc-notification-1-23-1", KucNotification);
