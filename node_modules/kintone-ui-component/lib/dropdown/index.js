...
let exportDropdown;
(() => {
    exportDropdown = window.customElements.get("kuc-dropdown-1-23-1");
    if (exportDropdown) {
        return;
    }
    class KucDropdown extends KucBase {
        constructor(props) {
            ...
            this._DISABLED_CLASS = "kuc-dropdown-1-23-1__group__select-menu__item--disabled";
    ...
    `;
      ...
      `;
        ...
        _getInfoHighlightItem() {
            const itemEl = this._highlightItemEl;
            if (itemEl === null)
                return { value: null, selectedIndex: "-1" };
            const value = itemEl.getAttribute("value");
            const selectedIndex = itemEl.dataset.index || "0";
        ...
        _actionClearAllHighlightMenuItem() {
            this._itemsEl.forEach((itemEl) => {
                itemEl.classList.remove("kuc-dropdown-1-23-1__group__select-menu__highlight");
            });
            this._actionRemoveActiveDescendant();
        }
        ...
        _actionHighlightMenuItem(item) {
            this._actionClearAllHighlightMenuItem();
            item.classList.add("kuc-dropdown-1-23-1__group__select-menu__highlight");
        }
        ...
        _getItemTemplate(item, index) {
            ...
            return html `
        <li
          class="kuc-dropdown-1-23-1__group__select-menu__item ${item.disabled
      ...
      `;
        ...
        _getDropdownIconSvgTemplate(checked, disabled) {
            return svg `
      ${checked
                ? svg `<svg
        ...
        _getItemElementWhenMouseOverDown(eventTarget) {
            if (eventTarget.classList.value
                .split(" ")
                .includes("kuc-dropdown-1-23-1__group__select-menu__item")) {
                return eventTarget;
            }
    ...
    __decorate([
        query(".kuc-dropdown-1-23-1__group__select-menu")
    ], KucDropdown.prototype, "_menuEl", void 0);
    __decorate([
        queryAll(".kuc-dropdown-1-23-1__group__select-menu__item")
    ], KucDropdown.prototype, "_itemsEl", void 0);
    __decorate([
        query("button.kuc-dropdown-1-23-1__group__toggle")
    ], KucDropdown.prototype, "_buttonEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-23-1__group__select-menu__item")
    ], KucDropdown.prototype, "_firstItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-23-1__group__select-menu__item:last-child")
    ], KucDropdown.prototype, "_lastItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-23-1__group__select-menu__item[aria-selected=true]")
    ], KucDropdown.prototype, "_selectedItemEl", void 0);
    __decorate([
        query(".kuc-dropdown-1-23-1__group__select-menu__highlight")
    ], KucDropdown.prototype, "_highlightItemEl", void 0);
    __decorate([
        queryAll(".kuc-dropdown-1-23-1__group__select-menu__item--disabled")
    ], KucDropdown.prototype, "_disabledItemsEl", void 0);
    __decorate([
        query(".kuc-base-error-1-23-1__error")
    ], KucDropdown.prototype, "_errorEl", void 0);
    window.customElements.define("kuc-dropdown-1-23-1", KucDropdown);
