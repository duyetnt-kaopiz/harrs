...
export class BaseLabel extends KucBase {
    ...
    _getTextTemplate() {
        return this.guid && this.guid !== ""
          ...
          >
        `
            : html ` <span class="kuc-base-label-1-23-1__text">${this.text}</span> `;
    }
}
__decorate([
...
if (!window.customElements.get("kuc-base-label-1-23-1")) {
    createStyleOnHeader(BASE_LABEL_CSS);
    window.customElements.define("kuc-base-label-1-23-1", BaseLabel);
}
