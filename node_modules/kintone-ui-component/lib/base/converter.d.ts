export declare const visiblePropConverter: {
    fromAttribute(value: string | null): value is null;
...
export declare const unsafeHTMLConverter: (element: string | HTMLElement) => import("lit/directive").DirectiveResult<typeof import("lit/directives/unsafe-html").UnsafeHTMLDirective>;
