...
export class BaseMobileTime extends KucBase {
    ...
    render() {
        return html `
      <fieldset
        class="kuc-base-mobile-time-1-23-1__group${this.disabled
            ? " kuc-base-mobile-time-1-23-1__group--disabled"
            : ""}${this.required ? " kuc-base-mobile-time-1-23-1__group--required" : ""}"
...
__decorate([
    query(".kuc-base-mobile-time-1-23-1__group__hours")
], BaseMobileTime.prototype, "_hoursEl", void 0);
__decorate([
    query(".kuc-base-mobile-time-1-23-1__group__minutes")
], BaseMobileTime.prototype, "_minutesEl", void 0);
if (!window.customElements.get("kuc-base-mobile-time-1-23-1")) {
    createStyleOnHeader(BASE_MOBILE_TIME_CSS);
    window.customElements.define("kuc-base-mobile-time-1-23-1", BaseMobileTime);
}
