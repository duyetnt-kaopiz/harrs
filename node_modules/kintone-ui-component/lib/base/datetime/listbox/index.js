...
export class BaseDateTimeListBox extends KucBase {
    ...
    _setHighlightItemEl(itemEl) {
        ...
        itemEl.classList.add("kuc-base-datetime-listbox-1-23-1__listbox--highlight");
    ...
    _removeHighlight() {
        ...
        this._highlightItemEl.classList.remove("kuc-base-datetime-listbox-1-23-1__listbox--highlight");
    }
...
__decorate([
    query(".kuc-base-datetime-listbox-1-23-1__listbox")
], BaseDateTimeListBox.prototype, "_listBoxEl", void 0);
__decorate([
    queryAll(".kuc-base-datetime-listbox-1-23-1__listbox__item")
], BaseDateTimeListBox.prototype, "_itemsEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-23-1__listbox__item")
], BaseDateTimeListBox.prototype, "_firstItemEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-23-1__listbox__item:last-child")
], BaseDateTimeListBox.prototype, "_lastItemEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-23-1__listbox--highlight")
], BaseDateTimeListBox.prototype, "_highlightItemEl", void 0);
__decorate([
    query(".kuc-base-datetime-listbox-1-23-1__listbox__item__icon")
...
if (!window.customElements.get("kuc-base-datetime-listbox-1-23-1")) {
    createStyleOnHeader(BASE_DATETIME_LISTBOX_CSS);
    window.customElements.define("kuc-base-datetime-listbox-1-23-1", BaseDateTimeListBox);
}
