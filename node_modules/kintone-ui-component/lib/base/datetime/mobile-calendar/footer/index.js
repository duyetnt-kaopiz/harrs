...
if (!window.customElements.get("kuc-base-mobile-datetime-calendar-footer-1-23-1")) {
    createStyleOnHeader(BASE_MOBILE_CALENDAR_FOOTER_CSS);
    window.customElements.define("kuc-base-mobile-datetime-calendar-footer-1-23-1", BaseMobileDateTimeCalendarFooter);
}
