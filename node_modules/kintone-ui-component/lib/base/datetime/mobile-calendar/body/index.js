...
export class BaseMobileDateTimeCalendarBody extends KucBase {
    ...
    _getDateClass(dateParts, isThisMonth) {
        if (isThisMonth) {
            ...
            if (isToday)
                return " kuc-base-mobile-datetime-calendar-body-1-23-1__table__date--today";
            return "";
        }
        return " kuc-base-mobile-datetime-calendar-body-1-23-1__table__date--other-month";
    }
              ...
              ${weeks.map((weekDate) => {
                ...
                return html `
                  <td
                    ...
                    class="kuc-base-mobile-datetime-calendar-body-1-23-1__table__date${isFocus
                    ? "--selected"
...
if (!window.customElements.get("kuc-base-mobile-datetime-calendar-body-1-23-1")) {
    createStyleOnHeader(BASE_MOBILE_CALENDAR_BODY_CSS);
    window.customElements.define("kuc-base-mobile-datetime-calendar-body-1-23-1", BaseMobileDateTimeCalendarBody);
}
