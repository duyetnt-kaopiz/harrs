...
__decorate([
    query(".kuc-base-mobile-datetime-calendar-header-1-23-1__group__center__month__select")
], BaseMobileDateTimeCalendarHeader.prototype, "_selectMonthEl", void 0);
__decorate([
    query(".kuc-base-mobile-datetime-calendar-header-1-23-1__group__center__year__select")
], BaseMobileDateTimeCalendarHeader.prototype, "_selectYearEl", void 0);
if (!window.customElements.get("kuc-base-mobile-datetime-calendar-header-1-23-1")) {
    createStyleOnHeader(BASE_MOBILE_CALENDAR_HEADER_CSS);
    window.customElements.define("kuc-base-mobile-datetime-calendar-header-1-23-1", BaseMobileDateTimeCalendarHeader);
}
