...
if (!window.customElements.get("kuc-base-mobile-datetime-calendar-1-23-1")) {
    createStyleOnHeader(BASE_MOBILE_CALENDAR);
    window.customElements.define("kuc-base-mobile-datetime-calendar-1-23-1", BaseMobileDateTimeCalendar);
}
