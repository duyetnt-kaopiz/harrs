...
import { calculateDistanceInput, getToggleIconSvgTemplate, setListBoxPosition, } from "../../../../utils";
...
__decorate([
    query(".kuc-base-datetime-header-year-1-23-1__toggle")
], BaseDateTimeHeaderYear.prototype, "_toggleEl", void 0);
if (!window.customElements.get("kuc-base-datetime-header-year-1-23-1")) {
    createStyleOnHeader(CALENDAR_HEADER_YEAR_CSS);
    window.customElements.define("kuc-base-datetime-header-year-1-23-1", BaseDateTimeHeaderYear);
}
