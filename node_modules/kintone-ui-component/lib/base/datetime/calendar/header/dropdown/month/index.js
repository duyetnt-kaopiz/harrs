...
import { calculateDistanceInput, getLocale, getToggleIconSvgTemplate, setListBoxPosition, } from "../../../../utils";
...
__decorate([
    query(".kuc-base-datetime-header-month-1-23-1__toggle")
], BaseDateTimeHeaderMonth.prototype, "_toggleEl", void 0);
if (!window.customElements.get("kuc-base-datetime-header-month-1-23-1")) {
    createStyleOnHeader(CALENDAR_HEADER_MONTH_CSS);
    window.customElements.define("kuc-base-datetime-header-month-1-23-1", BaseDateTimeHeaderMonth);
}
