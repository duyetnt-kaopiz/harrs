...
if (!window.customElements.get("kuc-base-datetime-calendar-header-1-23-1")) {
    createStyleOnHeader(CALENDAR_HEADER_CSS);
    window.customElements.define("kuc-base-datetime-calendar-header-1-23-1", BaseDateTimeCalendarHeader);
}
