...
export class BaseDateTimeCalendar extends KucBase {
    ...
    _calculateCalendarPosition(inputToRight, inputToLeft, type) {
        if (!this.parentElement)
            return;
        const input = this.parentElement.getElementsByClassName("kuc-base-date-1-23-1__input")[0];
...
__decorate([
    query(".kuc-base-datetime-calendar-1-23-1__group")
], BaseDateTimeCalendar.prototype, "_baseCalendarGroupEl", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-header-1-23-1__month")
], BaseDateTimeCalendar.prototype, "_monthEl", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-header-1-23-1__year")
], BaseDateTimeCalendar.prototype, "_yearEl", void 0);
__decorate([
    query(".kuc-base-datetime-header-month-1-23-1__listbox")
], BaseDateTimeCalendar.prototype, "_listBoxMonthEl", void 0);
__decorate([
    query(".kuc-base-datetime-header-year-1-23-1__listbox")
...
if (!window.customElements.get("kuc-base-datetime-calendar-1-23-1")) {
    createStyleOnHeader(CALENDAR_CSS);
    window.customElements.define("kuc-base-datetime-calendar-1-23-1", BaseDateTimeCalendar);
}
