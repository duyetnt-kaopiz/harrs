...
export class BaseDateTimeCalendarBody extends KucBase {
    ...
    _getDateClass(dateParts, isThisMonth) {
        if (isThisMonth) {
            ...
            if (isToday)
                return " kuc-base-datetime-calendar-body-1-23-1__table__date--selected--today";
            return "";
        }
        const isToday = this._isToday(dateParts);
        if (isToday)
            return " kuc-base-datetime-calendar-body-1-23-1__table__date--selected--today";
        return " kuc-base-datetime-calendar-body-1-23-1__table__date--other-month";
    }
            ...
            <tr>
              ${weeks.map((weekDate) => {
                ...
                return html `
                  <td
                    role="gridcell"
                    class="kuc-base-datetime-calendar-body-1-23-1__table__date${isFocus
                    ? "--selected"
...
__decorate([
    query('.kuc-base-datetime-calendar-body-1-23-1__table__date--selected[aria-selected="true"]')
], BaseDateTimeCalendarBody.prototype, "_selectedItem", void 0);
__decorate([
    query(".kuc-base-datetime-calendar-body-1-23-1__table__date--selected")
], BaseDateTimeCalendarBody.prototype, "_highlightItem", void 0);
__decorate([
    query('.kuc-base-datetime-calendar-body-1-23-1__table__date--selected[tabindex="0"]')
], BaseDateTimeCalendarBody.prototype, "_focusedItem", void 0);
if (!window.customElements.get("kuc-base-datetime-calendar-body-1-23-1")) {
    createStyleOnHeader(CALENDAR_BODY_CSS);
    window.customElements.define("kuc-base-datetime-calendar-body-1-23-1", BaseDateTimeCalendarBody);
}
