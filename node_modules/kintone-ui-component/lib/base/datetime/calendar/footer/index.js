...
if (!window.customElements.get("kuc-base-datetime-calendar-footer-1-23-1")) {
    createStyleOnHeader(CALENDAR_FOOTER_CSS);
    window.customElements.define("kuc-base-datetime-calendar-footer-1-23-1", BaseDateTimeCalendarFooter);
}
