...
export class BaseMobileDate extends KucBase {
    ...
    _getGroupClass() {
        let groupClass = "";
        if (this.disabled) {
            groupClass += " kuc-mobile-base-date-1-23-1__group--disabled";
        }
        if (this.required) {
            groupClass += " kuc-mobile-base-date-1-23-1__group--required";
        }
        return groupClass;
    }
...
__decorate([
    query(".kuc-mobile-base-date-1-23-1__group__button")
], BaseMobileDate.prototype, "_btnToggleEl", void 0);
__decorate([
    query(".kuc-mobile-base-date-1-23-1__group__input")
], BaseMobileDate.prototype, "_inputEl", void 0);
__decorate([
    query(".kuc-base-mobile-date-1-23-1__calendar")
], BaseMobileDate.prototype, "_calendarEl", void 0);
__decorate([
    state()
], BaseMobileDate.prototype, "_dateTimeCalendarVisible", void 0);
if (!window.customElements.get("kuc-mobile-base-date-1-23-1")) {
    createStyleOnHeader(BASE_MOBILE_DATE_CSS);
    window.customElements.define("kuc-mobile-base-date-1-23-1", BaseMobileDate);
}
