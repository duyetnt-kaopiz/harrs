...
export class BaseTime extends KucBase {
    ...
    _toggleDisabledGroup() {
        if (this.disabled)
            return this._inputGroupEl.classList.add("kuc-base-time-1-23-1__group--disabled");
        return this._inputGroupEl.classList.remove("kuc-base-time-1-23-1__group--disabled");
    }
    _updateInputValue() {
        var _a;
    ...
    _handleBlurButton() {
        this._inputGroupEl.classList.remove("kuc-base-time-1-23-1__group--focus");
    }
    _handleFocusButton(event) {
        event.stopPropagation();
        this._inputGroupEl.classList.add("kuc-base-time-1-23-1__group--focus");
    }
    _openListBoxByKey() {
        if (this._listBoxVisible)
            return false;
    ...
    _getColonTemplate() {
        return this._hours
            ? html ` <span class="kuc-base-time-1-23-1__group__colon">:</span> `
            : "";
    }
    _getSuffixTemplate() {
        return this.hour12
...
__decorate([
    query(".kuc-base-time-1-23-1__group__hours")
], BaseTime.prototype, "_hoursEl", void 0);
__decorate([
    query(".kuc-base-time-1-23-1__group__minutes")
], BaseTime.prototype, "_minutesEl", void 0);
__decorate([
    query(".kuc-base-time-1-23-1__group__suffix")
], BaseTime.prototype, "_suffixEl", void 0);
__decorate([
    query(".kuc-base-time-1-23-1__assistive-text")
], BaseTime.prototype, "_toggleEl", void 0);
__decorate([
    query(".kuc-base-time-1-23-1__group")
], BaseTime.prototype, "_inputGroupEl", void 0);
if (!window.customElements.get("kuc-base-time-1-23-1")) {
    createStyleOnHeader(BASE_TIME_CSS);
    window.customElements.define("kuc-base-time-1-23-1", BaseTime);
}
