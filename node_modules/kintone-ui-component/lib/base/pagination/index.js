...
(() => {
    exportPagination = window.customElements.get("kuc-base-pagination-1-23-1");
    if (exportPagination) {
        return;
    }
    class BasePagination extends KucBase {
        ...
        <div class="kuc-base-pagination-1-23-1__group" ?hidden="${!this.visible}">
          <button
            title="previous"
            class="kuc-base-pagination-1-23-1__group__pager-prev${this.isPrev
                ? ""
          ...
          >${this._getCurrentPageNumberTemplate()}<button
            title="next"
            class="kuc-base-pagination-1-23-1__group__pager-next${this.isNext
                ? ""
                : " kuc-base-pagination-1-23-1__group__pager-disable"}"
            type="button"
      ...
      `;
        ...
        _handleFocusPrevButton() {
            this._prevButtonEl.classList.add("kuc-base-pagination-1-23-1__group__pager--focus");
        }
        _handleBlurPrevButton() {
            this._prevButtonEl.classList.remove("kuc-base-pagination-1-23-1__group__pager--focus");
        }
        _handleMouseOverPrevButton() {
            this._prevButtonEl.classList.add("kuc-base-pagination-1-23-1__group__pager--horver");
        }
        _handleMouseLeavePrevButton() {
            this._prevButtonEl.classList.remove("kuc-base-pagination-1-23-1__group__pager--horver");
        }
        _handleClickNextButton(event) {
            event.stopPropagation();
            dispatchCustomEvent(this, "kuc:pagination-click-next");
        }
        _handleFocusNextButton() {
            this._nextButtonEl.classList.add("kuc-base-pagination-1-23-1__group__pager--focus");
        }
        _handleBlurNextButton() {
            this._nextButtonEl.classList.remove("kuc-base-pagination-1-23-1__group__pager--focus");
        }
        _handleMouseOverNextButton() {
            this._nextButtonEl.classList.add("kuc-base-pagination-1-23-1__group__pager--horver");
        }
        _handleMouseLeaveNextButton() {
            this._nextButtonEl.classList.remove("kuc-base-pagination-1-23-1__group__pager--horver");
        }
      ...
      `;
        ...
        _getCurrentPageNumberTemplate() {
            ...
            return html `<span class="kuc-base-pagination-1-23-1__group__pager-current"
        >${currentPageNumber}</span
      >`;
        }
        _createCurrentPageInfo() {
    ...
    ], BasePagination.prototype, "pagePosition", void 0);
    __decorate([
        property({ type: Number })
    ], BasePagination.prototype, "rowsPerPage", void 0);
    __decorate([
        property({ type: Number })
    ], BasePagination.prototype, "total", void 0);
    __decorate([
    ...
    __decorate([
        query(".kuc-base-pagination-1-23-1__group__pager-prev")
    ], BasePagination.prototype, "_prevButtonEl", void 0);
    __decorate([
        query(".kuc-base-pagination-1-23-1__group__pager-next")
    ], BasePagination.prototype, "_nextButtonEl", void 0);
    window.customElements.define("kuc-base-pagination-1-23-1", BasePagination);
