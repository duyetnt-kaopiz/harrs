...
export declare function validateDuplicatedValues(values: Array<string | undefined>): boolean;
...
export declare function validateNumberType(value: number): boolean;
export declare function validateArrayType<T>(value: T[]): boolean;
export declare const isHTMLElement: (element: string | HTMLElement) => boolean;
